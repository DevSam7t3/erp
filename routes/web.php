...
use App\Http\Controllers\EmployeOfTheMonthController;
use App\Http\Controllers\GridDashboardController;
...
Route::resource("/employe-of-the-month", EmployeOfTheMonthController::class);

// Route::get('/', [GridDashboardController, 'gridDashboard'])->name('dashboard');
...
Route::get('/', [GridDashboardController::class, 'gridDashboard'])->middleware(['XSS', 'revalidate','auth']);
