    ...
    <div class="m-header main-logo">
        <a href="/" class="b-brand">
            ...
            @if ($setting['cust_darklayout'] && $setting['cust_darklayout'] == 'on')
                <img src="{{ $logo . 'zetasoft_logo.png' }}" alt="{{ config('app.name', 'ERPGo-SaaS') }}"
                    class="logo logo-lg">
            @else
                <img src="{{ $logo . 'zetasoft_logo.png' }}" alt="{{ config('app.name', 'ERPGo-SaaS') }}"
                    class="logo logo-lg">
                ...
                @if (Gate::check('show hrm dashboard') ||
                    ...
                    <li
                        ...
                        <ul class="dash-submenu">
                            <li class="dash-item">
                                <a class="dash-link" href="/">{{ __(' Dashboard') }}</a>
                            </li>
                                            ...
                                            <li
                                                ...
                                                <ul class="dash-submenu">
                                                    ...
                                                    <li
                                                        ...
                                                        <a class="dash-link"
                                                            href="{{ route('report.sales') }}">{{ __('Income Report') }}</a>
                                                    </li>
                                                    <li
                                    ...
                                    <ul class="dash-submenu">
                                        @if (Gate::check('manage customer'))
                                            <li
                                                ...
                                                <a class="dash-link"
                                                    href="{{ route('customer.index') }}">{{ __('Clients') }}</a>
                                            </li>
                                        @endif
