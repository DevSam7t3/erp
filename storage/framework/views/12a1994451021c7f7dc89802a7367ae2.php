    ...
    <div class="m-header main-logo">
        <a href="/" class="b-brand">
            ...
            <?php if($setting['cust_darklayout'] && $setting['cust_darklayout'] == 'on'): ?>
                <img src="<?php echo e($logo . 'zetasoft_logo.png'); ?>" alt="<?php echo e(config('app.name', 'ERPGo-SaaS')); ?>"
                    class="logo logo-lg">
            <?php else: ?>
                <img src="<?php echo e($logo . 'zetasoft_logo.png'); ?>" alt="<?php echo e(config('app.name', 'ERPGo-SaaS')); ?>"
                    class="logo logo-lg">
                ...
                <?php if(Gate::check('show hrm dashboard') ||
                    ...
                    <li
                        ...
                        <ul class="dash-submenu">
                            <li class="dash-item">
                                <a class="dash-link" href="/"><?php echo e(__(' Dashboard')); ?></a>
                            </li>
                                            ...
                                            <li
                                                ...
                                                <ul class="dash-submenu">
                                                    ...
                                                    <li
                                                        ...
                                                        <a class="dash-link"
                                                            href="<?php echo e(route('report.sales')); ?>"><?php echo e(__('Income Report')); ?></a>
                                                    </li>
                                                    <li
                                    ...
                                    <ul class="dash-submenu">
                                        <?php if(Gate::check('manage customer')): ?>
                                            <li
                                                ...
                                                <a class="dash-link"
                                                    href="<?php echo e(route('customer.index')); ?>"><?php echo e(__('Clients')); ?></a>
                                            </li>
                                        <?php endif; ?>
...
<?php /**PATH D:\xampp\htdocs\codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>