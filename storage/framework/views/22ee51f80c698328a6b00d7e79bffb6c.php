...
<?php $__env->startPush('script-page'); ?>
    ...
    <script>
    swal({
        title: "Employ of the month",
        text: "Add employ of the month",
    })
</script>
<?php $__env->stopPush(); ?>
<?php $__env->startSection('breadcrumb'); ?>
<div class="container d-flex flex-row justify-content-between align-items-center gap-5">
    <div class="d-flex flex-row">
        <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a></li>
        <li class="breadcrumb-item"><?php echo e(__('HRM')); ?></li>
    </div>
    <a class="btn btn-primary ml-auto text-white" href="/employe-of-the-month">Employe Of The Month</a>
</div>
<?php $__env->stopSection(); ?>
<?php
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm\resources\views/dashboard/dashboard.blade.php ENDPATH**/ ?>